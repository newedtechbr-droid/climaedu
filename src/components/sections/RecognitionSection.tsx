...
const items = [
  {
    icon: Palette,
    title: "White-label",
    text: "Sua marca, sua identidade institucional.",
    accent: "olive" as const,
  },
  {
    icon: RouteIcon,
    title: "Trilhas por perfil",
    text: "Conteúdo direcionado por função e contexto.",
    accent: "olive" as const,
  },
  {
    icon: Sparkles,
    title: "IA com curadoria humana",
    text: "Velocidade da IA, validação técnica especializada.",
    accent: "olive" as const,
  },
  {
    icon: BarChart3,
    title: "Dashboards e relatórios",
    text: "Adesão, conclusão, proficiência e evidências.",
    accent: "terra" as const,
  },
  {
    icon: History,
    title: "Conteúdo versionado",
    text: "Atualizações rastreáveis e histórico auditável.",
    accent: "terra" as const,
  },
  {
    icon: Accessibility,
    title: "Acessibilidade",
    text: "Padrões inclusivos para todas as equipes.",
    accent: "olive" as const,
  },
  {
    icon: Shield,
    title: "LGPD",
    text: "Tratamento de dados em conformidade.",
    accent: "terra" as const,
  },
  {
    icon: Download,
    title: "Exportação de dados",
    text: "Relatórios prontos para auditoria e prestação de contas.",
    accent: "terra" as const,
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6">
        <FadeIn>
          <div className="mx-auto max-w-2xl text-center">
            <p
              className="mb-3 font-semibold uppercase tracking-[0.2em] text-primary"
              style={{ fontSize: "13px" }}
            >
              Atributos
            </p>
            <h2
              ...
              style={{ fontSize: "clamp(26px, 3vw, 36px)", lineHeight: 1.1 }}
            >
