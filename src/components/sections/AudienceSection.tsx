            ...
            <article className="relative isolate h-full overflow-hidden rounded-xl border border-border p-7 text-white">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="text-lg text-white">Órgãos Públicos</h3>
                </div>
              </div>
              ...
              <p className="mt-5 text-sm text-white/85">
                <strong className="font-medium text-white">Caso de uso:</strong> cumprir PNRS,
                estruturar plano climático municipal, capacitar equipe antes de auditoria, responder
                a exigências do MP ou TCE.
              </p>
              <p className="mt-3 text-sm text-white/85">
                <strong className="font-medium text-white">Contratação:</strong> por dispensa
                de licitação (projetos piloto), pregão eletrônico ou ata de registro de preços
                (Lei nº 14.133/2021).
              </p>
              <span className="mt-5 inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 text-xs text-white">
